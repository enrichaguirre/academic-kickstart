...
todos_bajaron = read_csv("./mardel informe/tods_bajaron_data.csv")

##### MAPA ####
geodataset = read_csv('./mardel informe/mardel_geo.csv')
...
library(viridisLite)
bajaron_mardel_nov = read_csv('./mardel informe/bajaron_mardel_nov.csv')
...
mardel=trimestr
SP0 <- rasterToPolygons(clump(r < 0.5), dissolve = TRUE)
...
z0_plot=ggplot(data = geodataset)+geom_polygon(aes(x=long, y = lat), fill = NA, colour = 'black')+
  geom_polygon(data = fortify(SP0), aes(x=long, y = lat, group = group), fill=NA, colour = "blue")+theme_void()

z1_plot=ggplot(data = geodataset)+geom_polygon(aes(x=long, y = lat), fill = NA, colour = 'black')+
  geom_polygon(data = fortify(SP1), aes(x=long, y = lat, group = group), fill=NA, colour = "blue")+theme_void()

z2_plot=ggplot(data = geodataset)+geom_polygon(aes(x=long, y = lat), fill = NA, colour = 'black')+
  geom_polygon(data = fortify(SP2), aes(x=long, y = lat, group = group), fill=NA, colour = "blue")+theme_void()

z3_plot=ggplot(data = geodataset)+geom_polygon(aes(x=long, y = lat), fill = NA, colour = 'black')+
  geom_polygon(data = fortify(SP3), aes(x=long, y = lat, group = group), fill=NA, colour = "blue")+theme_void()

z4_plot=ggplot(data = geodataset)+geom_polygon(aes(x=long, y = lat), fill = NA, colour = 'black')+
  geom_polygon(data = fortify(SP4), aes(x=long, y = lat, group = group), fill=NA, colour = "blue")+theme_void()

z5_plot=ggplot(data = geodataset)+geom_polygon(aes(x=long, y = lat), fill = NA, colour = 'black')+
  geom_polygon(data = fortify(SP5), aes(x=long, y = lat, group = group), fill=NA, colour = "blue")+theme_void()
z6_plot=ggplot(data = geodataset)+geom_polygon(aes(x=long, y = lat), fill = NA, colour = 'black')+
  geom_polygon(data = fortify(SP6), aes(x=long, y = lat, group = group), fill=NA, colour = "blue")+theme_void()


#
#trimestr['zona'] = z1$zona
#trimestr %>% write_csv('mardel_trimestre_zon.csv')
trimestr=read_csv('./mardel informe/mardel_trimestre_zon.csv')
...
SP0 <- rasterToPolygons(clump(r2 < 500), dissolve = TRUE)
SP1 <- rasterToPolygons(clump(r2 >= 500 & r2 <1000 ), dissolve = TRUE)
SP2 <- rasterToPolygons(clump(r2 >= 1000  & r2 <1500 ), dissolve = TRUE)
SP3 <- rasterToPolygons(clump(r2 >= 1500  & r2 <2000 ), dissolve = TRUE)
SP4 <- rasterToPolygons(clump(r2 >= 2000  & r2 <2500 ), dissolve = TRUE)
SP5 <- rasterToPolygons(clump(r2 >= 2500  & r2 <3000 ), dissolve = TRUE)
SP6 <- rasterToPolygons(clump(r2 >= 3000  & r2 <3500 ), dissolve = TRUE)
SP7 <- rasterToPolygons(clump(r2 >= 3500), dissolve = TRUE)
...
mardel = read_csv('./mardel informe/mardel_trim_zprecio.csv')
